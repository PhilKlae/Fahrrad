...
/* 
 *  !!!!!!!!!!!!!
Sketch um den KEY der NFC-Karte zu ändern und die Blocks zu beschreiben
 *  !!!!!!!!!!!!!
*/ 
...
void loop(void) {
  ...
  if (success) {
    ...
    if (uidLength == 4)
    {
      ...
      uint8_t keya[6] = { 'h','e','a','d','u','p' };//{0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };//{ 'h','e','a','d','u','p' };
      ...
      if (success)
      {
       ...
       uint8_t data[16];
        ...
        // If you want to write something to block 4 to test with, uncomment
         ...
         //uint8_t data[16] = { 'h','e','a','d','u','p',0xFF,0x07,0x80,0,0,0,0,0,0,0};
         //uint8_t data[16] = { 't','h','k','o','e','l','n','r','u','l','e','z','z','z',0,0};
